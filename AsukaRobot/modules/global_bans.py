...
import AsukaRobot.modules.sql.global_bans_sql as sql
from AsukaRobot.modules.sql.users_sql import get_user_com_chats
...
from AsukaRobot.modules.helper_funcs.misc import send_to_list
...
def gban(update: Update, context: CallbackContext):
    ...
    message.reply_text("Here We Goo!")
