...
@bot.on(events.NewMessage(pattern="^!?@/]AyakaRobot$"))

async def stsrt(event):

    await event.reply("Hey, I'm a Whisper Bot function for Ayaka!",
...
async def die(event):
    ...
    dn = event.builder.article(
        ...
        description="It's a whisper Bot function for Kurumi!\n(c) Reeshuxd",
...
To [{ui.user.first_name}!

Click The Below Button To See The Message!

Note: Only {ui.user.first_name} can open this!
    ...
    await event.answer(
            ...
            [dn],switch_pm="It's a secret message! Sssh",
